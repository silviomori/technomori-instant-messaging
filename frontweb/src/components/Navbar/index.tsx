...
const Navbar = () => {
  ...
  return (
    <nav className="navigation h-100 d-flex flex-column text-center navbar navbar-light hide-scrollbar">
      ...
      {/* Nav items */}
      <ul
        className="d-flex nav navbar-nav flex-row flex-xl-column flex-grow-1 justify-content-between align-items-center w-100 py-2 py-lg-4 px-3 px-lg-5 px-xl-3"
        role="tablist"
      >
